...
Spring_data_raw <- Spring_data_raw %>% mutate(as.factor(Block))
Spring_data_raw <- Spring_data_raw %>% mutate(as.factor(Plot))
Spring_data_raw <- Spring_data_raw %>% mutate(as.factor(Treatment))

...
Spring_data_raw <- Spring_data_raw %>% mutate(Block = as.factor(Block))
Spring_data_raw <- Spring_data_raw %>% mutate(Plot = as.factor(Plot))
Spring_data_raw <- Spring_data_raw %>% mutate(Treatment = as.factor(Treatment))

...
Description <- c(
  ...
  'Seed source',
  'Transect number', 
  'Collection point distance from start of transect',
  'How many times a plant touches the collection pole',
  'Other notes',
  'Species ID code',
  'Classification of groundcover',
  'Dead or alive', #unsure about this description
  'Type of plant',
...
write.csv(Metadata_better, "C:\\Users\\babyr\\AdvancedQuant\\MCRS_AdvQuant_W23\\Dataset_Metadata_20230201", row.names = TRUE)
...
```{r}
DNTransect_Primary <- load(file = "DNTransect_Primary.Rdata")
